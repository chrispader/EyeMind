...
const {setupTracking, sendSnapshotID, sendFullSnapshot, sendQuestionEvent, processGazeData, dataMapped, sendClickEvent} = require('../app/server/node/connectors/eye-tracker')
