...
import { isModelsFile } from '@/app/components/FileImport/loadFile'
import type { FileImportConfig } from '@/app/components/FileImport/types'
import {
  type Model,
  createDefaultModel,
  getModelIdFromFileName,
} from '@/app/model/models'
import { errorAlert, readFileContent } from '@/app/modules/utils/utils'
import { ROUTES_NAMES } from '@/app/routes'
import { useDraftModels, useModelActions } from '@/app/state/session'
