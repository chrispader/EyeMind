...
import { AnalysisPage } from '@/renderer/pages/AnalysisPage'
import { HomePage } from '@/renderer/pages/HomePage'
import { ConfigPagesWrapper } from '@/renderer/pages/config/ConfigPagesWrapper'
import { EyeTrackingPage } from '@/renderer/pages/config/EyeTrackingPage'
import { EyeTrackingLoadModelsPage } from '@/renderer/pages/config/eye-tracking/config/EyeTrackingLoadModelsPage'
import { EyeTrackingLoadQuestionsPage } from '@/renderer/pages/config/eye-tracking/config/EyeTrackingLoadQuestionsPage'
import { EyeTrackingLoadSessionPage } from '@/renderer/pages/config/eye-tracking/config/EyeTrackingLoadSessionPage'
import { EyeTrackingNewSessionPage } from '@/renderer/pages/config/eye-tracking/config/EyeTrackingNewSessionPage'
