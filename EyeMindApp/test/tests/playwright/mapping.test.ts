...
test.describe("mapping-after-data-collection-is-over", async() => {
	...
	test("old-ui-mapping-after-data-collection-is-over-no-link", async () => {
	  ...
	  const globalParameters =  await firstWindow.evaluate(() => {return window.globalParameters});
		...
		const gazeDataFilename = "test/data/recording/old-ui/no-link/ETdata.bem"
		const snapshotsContentDataFilename = "test/data/recording/old-ui/no-link/snapshots.bem"
		...
		const loadedState = readSmallJSON("test/data/recording/old-ui/no-link/stateWithMappedGazeData.json");
	...
	test("old-ui-mapping-after-data-collection-is-over-new-tab", async () => {
	...
	//	}, styleParameters);
	  ...
	  const globalParameters =  await firstWindow.evaluate(() => {return window.globalParameters});
		...
		//send mock recording data // the paths are in EyeMind\EyeTrackingServer\
		const gazeDataFilename = "test/data/recording/old-ui/new-tab/ETdata.bem"
		const snapshotsContentDataFilename = "test/data/recording/old-ui/new-tab/snapshots.bem"
		const mockRecordingData = {"action": 'mockRecording', "gazeDataFilename": gazeDataFilename, "snapshotsContentDataFilename": snapshotsContentDataFilename}
		await request({
		method: globalParameters.COMMUNICATION_METHOD_TO_ET_SERVER,
		uri: globalParameters.COMMUNICATION_URI_TO_ET_SERVER,
		...
		const loadedState = readSmallJSON("test/data/recording/old-ui/new-tab/stateWithMappedGazeData.json");
		const expectedMappedGazeData = loadedState.processedGazeData.gazeData
	...
	test("old-ui-mapping-after-data-collection-is-over-within-tab", async () => {
	...
	//	}, styleParameters);
	  ...
	  const globalParameters =  await firstWindow.evaluate(() => {return window.globalParameters});
		...
		//send mock recording data // the paths are in EyeMind\EyeTrackingServer\
		const gazeDataFilename = "test/data/recording/old-ui/within-tab/ETdata.bem"
		const snapshotsContentDataFilename = "test/data/recording/old-ui/within-tab/snapshots.bem"
		const mockRecordingData = {"action": 'mockRecording', "gazeDataFilename": gazeDataFilename, "snapshotsContentDataFilename": snapshotsContentDataFilename}
		await request({
		method: globalParameters.COMMUNICATION_METHOD_TO_ET_SERVER,
		uri: globalParameters.COMMUNICATION_URI_TO_ET_SERVER,
		...
		const loadedState = readSmallJSON("test/data/recording/old-ui/within-tab/stateWithMappedGazeData.json");
		const expectedMappedGazeData = loadedState.processedGazeData.gazeData
	...
	test("new-ui-mapping-after-data-collection-is-over-no-link", async () => {
	  ...
	  const globalParameters =  await firstWindow.evaluate(() => {return window.globalParameters});
		...
		//send mock recording data // the paths are in EyeMind\EyeTrackingServer\
		const gazeDataFilename = "test/data/recording/new-ui/no-link/ETdata.bem"
		const snapshotsContentDataFilename = "test/data/recording/new-ui/no-link/snapshots.bem"
		const mockRecordingData = {"action": 'mockRecording', "gazeDataFilename": gazeDataFilename, "snapshotsContentDataFilename": snapshotsContentDataFilename}
		await request({
		method: globalParameters.COMMUNICATION_METHOD_TO_ET_SERVER,
		uri: globalParameters.COMMUNICATION_URI_TO_ET_SERVER,
		...
		const loadedState = readSmallJSON("test/data/recording/new-ui/no-link/stateWithMappedGazeData.json");
		const expectedMappedGazeData = loadedState.processedGazeData.gazeData
	...
	test("new-ui-mapping-after-data-collection-is-over-new-tab", async () => {
	...
	//	}, styleParameters);
	  ...
	  const globalParameters =  await firstWindow.evaluate(() => {return window.globalParameters});
		...
		//send mock recording data // the paths are in EyeMind\EyeTrackingServer\
		const gazeDataFilename = "test/data/recording/new-ui/new-tab/ETdata.bem"
		const snapshotsContentDataFilename = "test/data/recording/new-ui/new-tab/snapshots.bem"
		const mockRecordingData = {"action": 'mockRecording', "gazeDataFilename": gazeDataFilename, "snapshotsContentDataFilename": snapshotsContentDataFilename}
		await request({
		method: globalParameters.COMMUNICATION_METHOD_TO_ET_SERVER,
		uri: globalParameters.COMMUNICATION_URI_TO_ET_SERVER,
		...
		const loadedState = readSmallJSON("test/data/recording/new-ui/new-tab/stateWithMappedGazeData.json");
		const expectedMappedGazeData = loadedState.processedGazeData.gazeData
	...
	test("new-ui-mapping-after-data-collection-is-over-within-tab", async () => {
	...
	//	}, styleParameters);
	  ...
	  const globalParameters =  await firstWindow.evaluate(() => {return window.globalParameters});
		...
		//send mock recording data // the paths are in EyeMind\EyeTrackingServer\
		const gazeDataFilename = "test/data/recording/new-ui/within-tab/ETdata.bem"
		const snapshotsContentDataFilename = "test/data/recording/new-ui/within-tab/snapshots.bem"
		const mockRecordingData = {"action": 'mockRecording', "gazeDataFilename": gazeDataFilename, "snapshotsContentDataFilename": snapshotsContentDataFilename}
		await request({
		method: globalParameters.COMMUNICATION_METHOD_TO_ET_SERVER,
		uri: globalParameters.COMMUNICATION_URI_TO_ET_SERVER,
		...
		const loadedState = readSmallJSON("test/data/recording/new-ui/within-tab/stateWithMappedGazeData.json");
		const expectedMappedGazeData = loadedState.processedGazeData.gazeData
