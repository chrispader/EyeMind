...
function removeElementAttributes(elementsToEdit,data) {
  ...
  const elements = dom.window.document.querySelectorAll(Object.keys(elementsToEdit).join(", "));
...
function removeClassAttrFromSpecificSVGs(code) {
  ...
  var relevantElements = dom.window.document.querySelectorAll('svg[width="100%"][height="100%"]');
...
export {dragAndDropFile,delay,removeElementAttributes,loadFile, saveFile, removeClassAttrFromSpecificSVGs, removeHoverClassOption, readSmallJSON}